...
public class MyListViewApader extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        /**
         * True and false are used to solve the reuse problem.
         * If the current flag is selected,
         * the item font color will turn red, the red vertical bar will display,
         * And the item background color will turn white
         */
        ...
        /**
         * If it is not selected, the item font color will turn black
         * the red vertical bar will be hidden, and the item background will turn gray
         */
